...
[![Verify](https://github.com/LemonScripter/istio-causal-bridge/actions/workflows/verify.yml/badge.svg)](https://github.com/LemonScripter/istio-causal-bridge/actions/workflows/verify.yml)
[![Status](https://img.shields.io/badge/Status-Hardened--Prototype-blue)](https://github.com/LemonScripter/istio-causal-bridge/blob/master/ROADMAP.md)
